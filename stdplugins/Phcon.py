...
@borg.on(admin_cmd(pattern="pc ?(.+?|) --(battery|fileio|oload|anonfiles|transfer|filebin|anonymousfiles|megaupload|bayfiles)"))
async def _(event):
	...
	CMD_WEB = {
                "battery": "async with event.client.conversation("@batterylevelbot") as conv:/n    await conv.send_message("🔋 Battery")/n    r = await conv.get_response()/n    print(r.message)",
